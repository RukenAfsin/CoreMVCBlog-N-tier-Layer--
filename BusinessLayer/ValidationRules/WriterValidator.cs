...
namespace BusinessLayer.ValidationRules
{
    public class WriterValidator : AbstractValidator<Writer>
    {
        public WriterValidator()
        {
            ...
            RuleFor(x => x.WriterPassword).NotEmpty().WithMessage("Şisre boş geçilemez");
            RuleFor(x => x.WriterName).MinimumLength(2).WithMessage("lütfen en az iki karakter girişi yapın");
            RuleFor(x => x.WriterName).MaximumLength(50).WithMessage("lMax 50 karakterli veri girişi olabilir!");
